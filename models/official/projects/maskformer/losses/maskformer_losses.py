...
class Loss(tf.keras.losses.Loss):
    ...
    def call(self, outputs, y_true):
        ...
        print("[INFO] Indices shape :", indices.shape)
        ...
        for each_batch in y_true:
            ...
            tgt_ids = tf.expand_dims(tf.concat([each_batch['labels'], tf.zeros([num_zeros], dtype=tf.int64)],0),0)
        ...
        print("[INFO] Classes assigned shape :", cls_assigned.shape)
        print("[INFO] Classes Target shape :", target_classes.shape)
        ...
        print("[INFO] Cross Entropy loss :", cls_loss)
        exit()
