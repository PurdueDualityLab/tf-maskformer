...
from official.projects.maskformer.configs import maskformer  # pylint: disable=unused-import
from official.projects.maskformer.tasks import panoptic_maskformer  # pylint: disable=unused-import
...
def main(_):
  ...
  if FLAGS.tpu:
    ...
    c = Client(
        ...
        project=os.environ['TPU_PROJECT'])
    c.configure_tpu_version(
        os.environ["TPU_SOFTWARE"],
