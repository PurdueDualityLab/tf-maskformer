...
<<<<<<< HEAD
	...
	def initialize(self, model: tf.keras.Model) -> None:
		...
		print("[INFO] Starting profiler server......")
	...
	def build_losses(self, output, labels, aux_outputs=None):
		...
		#TODO : Not implemented auxilary outputs
	...
	#####################################################################
		# # Trainer class handles loss metric for you.
		logs = {self.loss: total_loss}
		outputs = {"pred_logits": outputs["class_prob_predictions"], "pred_masks": outputs["mask_prob_predictions"]}
