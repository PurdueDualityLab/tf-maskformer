...
export TFRECORDS_DIR="/depot/davisjam/data/akshath/datasets/subset"
...
export LOG='/depot/davisjam/data/akshath/MaskFormer_vishal/tf-maskformer/models/official/projects/maskformer/losses/test/logs/losses_a30.txt'
