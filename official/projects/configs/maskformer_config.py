...
MASK_FORMER_CFG.override({
    ...
    'train': {
        ...
        'train_file_pattern': '/scratch/gilbreth/abuynits/coco_ds/coco_tfrecords/*',  # TODO: fix this sketchiness
    ...
    'eval': {
        'eval_file_pattern': '/scratch/gilbreth/abuynits/coco_ds/coco_tfrecords/*',  # TODO: fix this sketchiness
        'type': 'box_and_mask',
