...
class DistributedExecutor(object):
    ...
    def __init__(self, strategy, params, model_fn=None, loss_fn=None, is_multi_host=False):
        """Constructor.
    ...
    def train(
        ...
        train_iterator = self.get_input_iterator(train_input_fn, strategy)
        train_loss = None
        ...
        if test_step:
            eval_iterator = self.get_input_iterator(eval_input_fn, strategy)
